# GEMINI.md - ai_sdlc_method Project Guide
...
5. **Gemini Code Plugins** - Installable methodology and standards as plugins
...
│
├── gemini-code/plugins/                     # Gemini Code plugins and skills
...
│
├── .gemini-plugin/              # Root plugin metadata
├── marketplace.json             # Gemini Code marketplace registry
...
**IMPORTANT**: This project uses an **implicit session model** where context loads automatically when Gemini Code starts.

### What Auto-Loads

When you open this project in Gemini Code, the following context is automatically available:

1. **This file (GEMINI.md)** - Project guide, methodology overview, development guidelines
...
- **No ceremony** - Just open Gemini and start working
- **One file** - ACTIVE_TASKS.md has both tasks and work context

### How It Works

```
Open Gemini → GEMINI.md mentions ACTIVE_TASKS.md → Work → /aisdlc-checkpoint-tasks → Close
                          ↑                                         ↓
...
```bash
# Install Gemini Code plugin
/plugin marketplace add foolishimp/ai_sdlc_method
/plugin install @aisdlc/aisdlc-methodology

# Gemini now has access to complete 7-stage methodology
```

### Ask Gemini to Follow 7-Stage Process
...
stages_config = Path("gemini-code/plugins/aisdlc-methodology/config/stages_config.yml")
...
👉 **Read Full Principles**: [gemini-code/plugins/aisdlc-methodology/docs/principles/KEY_PRINCIPLES.md](gemini-code/plugins/aisdlc-methodology/docs/principles/KEY_PRINCIPLES.md)
...
👉 **Read Full Workflow**: [gemini-code/plugins/aisdlc-methodology/docs/processes/TDD_WORKFLOW.md](gemini-code/plugins/aisdlc-methodology/docs/processes/TDD_WORKFLOW.md)
...
2. **[gemini-code/plugins/aisdlc-methodology/config/stages_config.yml](gemini-code/plugins/aisdlc-methodology/config/stages_config.yml)** - 7-stage agent specifications (1,273 lines)
...
```yaml
# .claude-gemini-code/plugins/my-project/config.yml
ai_sdlc:
  methodology_plugin: "file://gemini-code/plugins/aisdlc-methodology/config/stages_config.yml"
...
- **Ask Gemini Code**: I'm here to help!
