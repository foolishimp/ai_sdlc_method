...
from imp_codex.tests.uat.conftest import CONFIG_DIR, EDGE_PARAMS_DIR
...
class TestContextConstraintSurface:
    ...
    def test_context_types_defined(self, initialized_workspace):
        ...
        ctx = initialized_workspace / ".ai-workspace" / "codex" / "context"
    ...
    def test_context_version_control(self, initialized_workspace):
        ...
        ctx_path = (
            initialized_workspace / ".ai-workspace" / "codex" / "context"
