...
- [AI_SDLC_ASSET_GRAPH_MODEL.md](../../../specification/core/AI_SDLC_ASSET_GRAPH_MODEL.md) §5.2 (Spec Reproducibility)
- [AISDLC_V2_DESIGN.md](../AISDLC_V2_DESIGN.md) §2.3 (Context Management)
- [AISDLC_IMPLEMENTATION_REQUIREMENTS.md](../../../specification/requirements/AISDLC_IMPLEMENTATION_REQUIREMENTS.md) REQ-INTENT-004
