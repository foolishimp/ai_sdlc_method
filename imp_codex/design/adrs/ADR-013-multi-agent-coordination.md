...
- [AI_SDLC_ASSET_GRAPH_MODEL.md](../../../specification/core/AI_SDLC_ASSET_GRAPH_MODEL.md) §6.7 (Basis Projections), §7.5 (Event Sourcing), §7.7.6 (Markov Boundaries)
- [AISDLC_IMPLEMENTATION_REQUIREMENTS.md](../../../specification/requirements/AISDLC_IMPLEMENTATION_REQUIREMENTS.md) §12 (Multi-Agent Coordination)
- [GEMINI_BOOTSTRAP_DESIGN.md](../../../imp_gemini/design/GEMINI_BOOTSTRAP_DESIGN.md) — agent registry, cross-agent signals, "Immutability over Mutexes" framing
