...
"""Fixtures for Bedrock implementation tests."""
...
# Bedrock implementation paths
IMP_BEDROCK = PROJECT_ROOT / "imp_bedrock"
DESIGN_DIR = IMP_BEDROCK / "design"
PLUGIN_ROOT = IMP_BEDROCK / "code"
...
def pytest_ignore_collect(collection_path, config):  # pragma: no cover
    ...
    return "imp_bedrock/tests/e2e/runs/" in str(collection_path)
