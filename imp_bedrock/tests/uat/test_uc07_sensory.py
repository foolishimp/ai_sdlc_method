...
from imp_bedrock.tests.uat.conftest import make_event, write_events
from imp_bedrock.tests.uat.workspace_state import (
...
class TestReviewBoundary:
    ...
    def test_review_boundary_tools(self, affect_triage):
        """Review boundary defines API endpoints for human interaction."""
        boundary = affect_triage.get("review_boundary", {})
    ...
    def test_human_required_for_modifications(self, affect_triage):
        """State modifications require human approval."""
        boundary = affect_triage.get("review_boundary", {})
