...
from imp_bedrock.tests.uat.conftest import (
    CONFIG_DIR,
    PLUGIN_ROOT,
    make_event,
    write_events,
...
class TestFeedbackLoop:
    ...
    def test_new_intent_enters_graph(self, converged_workspace):
        ...
        from imp_bedrock.tests.uat.workspace_state import get_active_features
...
class TestObserverAgents:
    ...
    def test_cicd_observer_rollback(self, affect_triage):
        ...
        assert "state_modification" in human_required, \
            "Human must be required for state modifications (rollback)"
