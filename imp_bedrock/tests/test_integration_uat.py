...
specification/, imp_bedrock/design/, imp_bedrock/code/, and .ai-workspace/.
...
class TestEndToEndTraceability:
    ...
    def setup(self):
        ...
        self.design = _read_file(DESIGN_DIR / "BEDROCK_GENESIS_DESIGN.md")
    ...
    def test_all_spec_keys_appear_in_feature_vectors(self):
        ...
        # REQ-TOOL-012, -013, -014 are new requirements not yet added to FEATURE_VECTORS.md
        known_pending = {"REQ-TOOL-012", "REQ-TOOL-013", "REQ-TOOL-014"}
        missing = self.spec_keys - self.fv_keys - known_pending
    ...
    def test_coverage_table_complete(self):
        ...
        # REQ-TOOL-012, -013, -014 are new requirements not yet added to FEATURE_VECTORS.md
        known_pending = {"REQ-TOOL-012", "REQ-TOOL-013", "REQ-TOOL-014"}
        missing = spec_req_keys - table_keys - known_pending
...
class TestObserverIntegration:
    ...
    def test_observer_event_schema_in_design(self):
        """Design doc must reference observer agents in lifecycle coverage."""
        content = _read_file(DESIGN_DIR / "BEDROCK_GENESIS_DESIGN.md")
