...
class TestRequirementsLineage:
    ...
    CONSCIOUSNESS_REQS = ["REQ-LIFE-005", "REQ-LIFE-006", "REQ-SENSE-001"]
...
class TestSensoryRequirements:
    ...
    def test_design_doc_claims_all_feature_vectors(self):
        ...
        with open(design_path) as f:
            content = f.read()
        assert "11/11 feature vectors aligned" in content
...
class TestMultiAgentCoordination:
    ...
    def test_design_doc_has_multi_agent_section(self):
        ...
        with open(design_path) as f:
            content = f.read()
        assert "4.4 Multi-Agent Coordination" in content
    ...
    def test_adr_013_mentions_no_lock_files(self):
        ...
        with open(adr_path) as f:
            content = f.read()
        assert "Zero deadlocks" in content or "No serialiser process" in content
