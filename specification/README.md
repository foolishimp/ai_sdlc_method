...
| [ADR-S-035](adrs/ADR-S-035-genesis-dsl-topology-language.md) | Genesis DSL — Topology Language | **PROPOSAL** — GTL replaces static file bundles; chart/values/release separation (Helm analogy); graph algebra (extends, \, +); higher-order compositions; live topology vs compiled templates |
