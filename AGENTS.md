...
- Inside `imp_codex` and `.ai-workspace/comments/codex`, changes are allowed only when the user explicitly says: `start` or Equivalent but explict term to proceed.
