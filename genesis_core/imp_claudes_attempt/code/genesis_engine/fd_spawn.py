# Implements: GENESIS_ENGINE_SPEC §3.3 (Stuck Detection), §3.4 (Spawn)
...
def detect_spawn_condition(
    ...
    """Check if a feature is stuck — same non-zero delta repeated.
...
def check_time_box(feature_vector: dict) -> str:
    """Check time-box status: 'active' | 'expiring' | 'expired' | 'disabled'."""
