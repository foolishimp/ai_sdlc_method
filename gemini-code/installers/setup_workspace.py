...
class WorkspaceSetup(InstallerBase):
    ...
    def _print_next_steps(self):
        ...
        print("4. Add your first task: edit .ai-workspace/tasks/active/ACTIVE_TASKS.md")
        print("\n💡 Tip: Install Gemini commands with setup_commands.py for custom command support")
