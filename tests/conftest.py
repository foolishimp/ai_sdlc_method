...
"""Shared fixtures for AI SDLC methodology tests."""
...
PLUGIN_ROOT = PROJECT_ROOT / "claude-code/.claude-plugin/plugins/aisdlc-methodology/v2"
...
SPEC_DIR = DOCS_DIR / "specification"
...
def load_yaml(path: pathlib.Path) -> dict:
    ...
    # Merge all non-None documents into one dict
    result = {}
    for doc in docs:
        if doc is not None:
            result.update(doc)
