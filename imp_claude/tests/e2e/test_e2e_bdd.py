...
All classes share the session-scoped `converged_project` fixture — Claude runs ONCE.

Spec: imp_claude/tests/e2e/scenarios/convergence_lifecycle/spec.md

Run:
    pytest imp_claude/tests/e2e/test_e2e_bdd.py -v -m e2e -s
"""
...
class TestUC09UX_StateNavigation:
    ...
    def test_project_initialized_event_present(self, converged_project: pathlib.Path):
        """
    ...
    def test_all_standard_edges_started(self, converged_project: pathlib.Path):
        """
        Given: converged project
    ...
    def test_all_standard_edges_converged(self, converged_project: pathlib.Path):
        """
        Given: converged project
    ...
    def test_edges_traversed_in_topological_order(self, converged_project: pathlib.Path):
        """
        Given: converged project
    ...
    def test_feature_referenced_in_events(self, converged_project: pathlib.Path):
        """
        Given: converged project
...
class TestUC04Feature_Trajectory:
    ...
    def test_trajectory_contains_all_standard_edges(self, converged_project: pathlib.Path):
        """
    ...
    def test_converged_trajectory_nodes_have_status(self, converged_project: pathlib.Path):
        """
    ...
    def test_feature_status_is_converged(self, converged_project: pathlib.Path):
        """
    ...
    def test_feature_vector_has_req_id(self, converged_project: pathlib.Path):
        """
        Given: feature vector for REQ-F-CONV-001
...
class TestUC05Edge_TDDCoevolution:
    ...
    def test_code_and_tests_both_generated(self, converged_project: pathlib.Path):
        """
        ...
        """
        code_files, test_files = find_python_files(converged_project)
        assert code_files, (
    ...
    def test_code_has_implements_tags(self, converged_project: pathlib.Path):
        """
    ...
    def test_tests_have_validates_tags(self, converged_project: pathlib.Path):
        """
        Given: test files
        When: I grep for REQ key tags
    ...
    def test_req_key_coverage_in_code(self, converged_project: pathlib.Path):
        """
    ...
    def test_req_key_coverage_in_tests(self, converged_project: pathlib.Path):
        """
    ...
    def test_code_edge_is_bidirectional_in_events(self, converged_project: pathlib.Path):
        """
        Given: events.jsonl
    ...
    def test_generated_tests_pass_deterministically(self, converged_project: pathlib.Path):
        """
...
class TestUC01Iter_ConvergenceProperties:
    ...
    def test_each_edge_has_complete_lifecycle(self, converged_project: pathlib.Path):
        """
        Given: events.jsonl
    ...
    def test_each_edge_has_evaluator_details(self, converged_project: pathlib.Path):
        """
    ...
    def test_delta_zero_on_all_converged_edges(self, converged_project: pathlib.Path):
        """
    ...
    def test_evaluators_differ_between_edges(self, converged_project: pathlib.Path):
        """
