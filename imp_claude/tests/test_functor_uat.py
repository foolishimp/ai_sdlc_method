...
from genisis.engine import EngineConfig, IterationRecord, iterate_edge, run_edge, run
...
def _scaffold_green_project(tmp_path):
...
def _scaffold_broken_project(tmp_path):
