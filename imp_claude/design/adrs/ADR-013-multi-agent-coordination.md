...
- [AI_SDLC_ASSET_GRAPH_MODEL.md](../../../specification/core/AI_SDLC_ASSET_GRAPH_MODEL.md) §4.6 (IntentEngine), §6.7 (Basis Projections), §7.5 (Event Sourcing), §7.7.6 (Markov Boundaries)
