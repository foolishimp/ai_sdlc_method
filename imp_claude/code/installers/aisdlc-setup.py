...
Usage:
    ...
    python aisdlc-setup.py --no-workspace

    # Preview changes without writing
    python aisdlc-setup.py --dry-run
...
PLUGIN_NAME = "aisdlc-methodology-v2"
MARKETPLACE_NAME = "aisdlc"
PLUGIN_BASE = f"imp_claude/code/.claude-plugin/plugins/aisdlc-methodology/v2"
...
# Generated by aisdlc-setup.py — fill in during requirements→design edge
...
No active tasks. Run `/aisdlc-start` to begin.
"""
...
def cmd_install(args) -> int:
    ...
    if args.dry_run:
        ...
        print("    2. Run /aisdlc-start to begin")
        print()
        print("  Verify installation:")
        print("    python aisdlc-setup.py verify")
    else:
